...
class CrudCursosDeCarreras : AppCompatActivity(), RecyclerView_Adapter2.onJobFormClickListener {
        ...
        val itemTouchHelperCallback = object : ItemTouchHelper.SimpleCallback(ItemTouchHelper.UP or ItemTouchHelper.DOWN or ItemTouchHelper.START or ItemTouchHelper.END, ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                if(direction == ItemTouchHelper.LEFT){
                    ...
                    adaptador2 = RecyclerView_Adapter2(jobforms.getApplications(), this@CrudCursosDeCarreras)
                    ...
                    val i = Intent(this@CrudCursosDeCarreras, ModificarJobApplication::class.java)
            ...
            override fun onChildDraw(c: Canvas, recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder, dX: Float, dY: Float, actionState: Int, isCurrentlyActive: Boolean) {
                ...
                RecyclerViewSwipeDecorator.Builder(this@CrudCursosDeCarreras, c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive)
                    .addSwipeLeftBackgroundColor(ContextCompat.getColor(this@CrudCursosDeCarreras, R.color.red))
                    .addSwipeLeftActionIcon(R.drawable.ic_baseline_delete_24)
                    .addSwipeRightBackgroundColor(ContextCompat.getColor(this@CrudCursosDeCarreras, R.color.green))
...
//
    ...
    private fun getListOfForms() {
        ...
        adaptador2 = RecyclerView_Adapter2(nForms, this@CrudCursosDeCarreras)
        lista2.adapter = adaptador2
    }

    override fun onItemClick(form: JobForm) {
        val i = Intent(this@CrudCursosDeCarreras, ConsultarJobApplication::class.java)
