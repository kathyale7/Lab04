...
class CrudCursosDeCiclos : AppCompatActivity(), RecyclerView_Adapter2.onJobFormClickListener {
        ...
        val itemTouchHelperCallback = object : ItemTouchHelper.SimpleCallback(ItemTouchHelper.UP or ItemTouchHelper.DOWN or ItemTouchHelper.START or ItemTouchHelper.END, ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                if(direction == ItemTouchHelper.LEFT){
                    ...
                    adaptador2 = RecyclerView_Adapter2(jobforms.getApplications(), this@CrudCursosDeCiclos)
                    ...
                    val i = Intent(this@CrudCursosDeCiclos, ModificarJobApplication::class.java)
            ...
            override fun onChildDraw(c: Canvas, recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder, dX: Float, dY: Float, actionState: Int, isCurrentlyActive: Boolean) {
                ...
                RecyclerViewSwipeDecorator.Builder(this@CrudCursosDeCiclos, c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive)
                    .addSwipeLeftBackgroundColor(ContextCompat.getColor(this@CrudCursosDeCiclos, R.color.red))
                    .addSwipeLeftActionIcon(R.drawable.ic_baseline_delete_24)
                    .addSwipeRightBackgroundColor(ContextCompat.getColor(this@CrudCursosDeCiclos, R.color.green))
...
//
    ...
    private fun getListOfForms() {
        ...
        adaptador2 = RecyclerView_Adapter2(nForms, this@CrudCursosDeCiclos)
        lista2.adapter = adaptador2
    }

    override fun onItemClick(form: JobForm) {
        val i = Intent(this@CrudCursosDeCiclos, ConsultarJobApplication::class.java)
